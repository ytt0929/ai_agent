...
export const materialPackages = [
  ...
  },
  {
    id: 'MAT-004',
    enterpriseName: '唐山物桥商贸有限公司',
    packageName: '唐山物桥商贸有限公司 尽调资料包',
    source: '智能尽调',
    materialCount: 8,
    missingCount: 4,
    relatedReportId: 'RPT-TS-WQ',
    updatedAt: '2026-07-02',
    materials: [
      { id: 'm16', name: '营业执照', type: '证照', source: '资料识别', status: '已关联', relatedSections: ['basic'], extractedSummary: '企业名称：唐山物桥商贸有限公司，统一信用代码：91130203MA7EEQ2N0T，注册资本500万，法定代表人马丽', usedInGeneration: true, confidence: 0.99, updatedAt: '2026-07-02' },
      { id: 'm17', name: '纳税申报表', type: '税务', source: '资料识别', status: '已关联', relatedSections: ['finance'], extractedSummary: '2025年度申报收入2175.46万元，税负率0.8%', usedInGeneration: true, confidence: 0.95, updatedAt: '2026-07-02' },
      { id: 'm18', name: '增值税发票', type: '税务', source: '资料识别', status: '已关联', relatedSections: ['finance'], extractedSummary: '开票收入2275.98万元，进项128份，销项96份', usedInGeneration: true, confidence: 0.96, updatedAt: '2026-07-02' },
      { id: 'm19', name: '企业所得税', type: '税务', source: '资料识别', status: '已关联', relatedSections: ['finance'], extractedSummary: '企业所得税申报资料已采集', usedInGeneration: true, confidence: 0.93, updatedAt: '2026-07-02' },
      { id: 'm20', name: '发票明细', type: '税务', source: '资料识别', status: '已关联', relatedSections: ['finance'], extractedSummary: '发票明细清单已采集', usedInGeneration: true, confidence: 0.92, updatedAt: '2026-07-02' },
      { id: 'm21', name: '纳税评级', type: '税务', source: '资料识别', status: '已关联', relatedSections: ['basic'], extractedSummary: '纳税信用A级', usedInGeneration: true, confidence: 0.98, updatedAt: '2026-07-02' },
      { id: 'm22', name: '银行流水摘要', type: '银行', source: '资料识别', status: '识别中', relatedSections: ['finance'], extractedSummary: '银行流水正在识别中...', usedInGeneration: false, confidence: 0, updatedAt: '2026-07-02' },
      { id: 'm23', name: '工商登记信息', type: '工商', source: '资料识别', status: '已关联', relatedSections: ['basic'], extractedSummary: '工商登记信息：正常存续，成立日期2021-12-24', usedInGeneration: true, confidence: 0.97, updatedAt: '2026-07-02' },
    ],
    missingMaterials: ['最新财务报表', '主要合同', '应收账款明细', '电费缴费记录'],
  },
  {
    id: 'MAT-003',
    enterpriseName: '杭州智造装备有限公司',
